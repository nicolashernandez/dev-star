...
Info: MboxReaderCR - # of message with a null id: 19
 */
public class EMNLP14JTextTileWF {
...
//	final static String ENCODING = "utf-8"; 
	...
	public static void main(String[] args) throws Exception {
		...
		URL dataUrl=  EMNLP14JTextTileWF.class.getResource(dataFileName);
		...
		dataPath = "/media/ext4/workspace/data/ubuntu-users/email.message.starter-wi-inlineReplying.tok";
...
*/
		...
		AnalysisEngineDescription texttilingd = createEngineDescription(JTextTileFitAE.class,
				//JTextTileFitAE.PARAM_COVERING_ANNOTATION, "",
