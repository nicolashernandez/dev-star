...
public class Adjectif extends Mot {
   ...
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Adjectif.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Adjectif(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Adjectif(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Adjectif(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
