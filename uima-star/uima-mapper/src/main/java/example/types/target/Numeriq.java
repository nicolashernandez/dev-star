 ...
 * @generated */
public class Numeriq extends Annotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Numeriq.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Numeriq(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Numeriq(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Numeriq(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
