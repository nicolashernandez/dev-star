 ...
 */
public class MyFirstUIMAApplication implements StatusCallbackListener{
	...
	public static void main(String[] args) {
		 ...
		 */
		MyFirstUIMAApplication aMyFirstUIMAApplication = new MyFirstUIMAApplication();
...
//		setConfigurationParameter(fileSystemCRResourceSpecifier,"MIME", "text/plain");
		...
		aCPM.addStatusCallbackListener(MyFirstUIMAApplication.this);
