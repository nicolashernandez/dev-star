...
import common.types.extml.XMLAttributeAnnotation;
import common.types.extml.XMLElementAnnotation;
...
public  class XMLSaxHandler extends DefaultHandler {
	 ...
	 * Fonctionne de paire avec insideText
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (debug) {
			...
			for (int indent=0 ; indent < elementOffsetStackCursor ; indent++) System.out.print ("--");
			System.out.print("Debug: depth>"+elementOffsetStackCursor+"< characters ch>");
		...
		if (debug) {
			System.out.println ("Debug: #currentOpenElementWithTheBeginToSet>"+currentOpenElementWithTheBeginToSet+"<");
