...
public class XMLAttributeAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public String getQualifiedName(int addr) {
      ...
      jcas.throwFeatMissing("qualifiedName", "fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public String getLocalName(int addr) {
      ...
      jcas.throwFeatMissing("localName", "fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public int getElement(int addr) {
      ...
      jcas.throwFeatMissing("element", "fr.univnantes.lina.uima.connectors.types.XMLAttributeAnnotation");
  ...
  public XMLAttributeAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_element = jcas.getRequiredFeatureDE(casType, "element", "fr.univnantes.lina.uima.connectors.types.XMLElementAnnotation", featOkTst);
