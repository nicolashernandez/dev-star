...
//	final static String ENCODING = "utf-8"; 
	...
	public static void main(String[] args) throws Exception {
		...
		URL dataUrl=  LAW8JTextTileWF.class.getResource(dataFileName);
...
*/
		...
		AnalysisEngineDescription wstd = createEngineDescription(WhitespaceRegexPatternTokenizerAE.class
				);
		...
		AnalysisEngineDescription texttilingd = createEngineDescription(JTextTileFitAE.class,
				...
				JTextTileFitAE.PARAM_OUTPUT_DIR, "/home/hernandez-n/workspace/data/ubuntu-users/email.message.tagged.segmColex.textTiling",
		...
		AnalysisEngineDescription aaed = createEngineDescription(wstd, texttilingd); //
