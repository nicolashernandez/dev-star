 ...
 * @generated */
public class NomCommun extends Nom {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(NomCommun.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public NomCommun(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public NomCommun(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public NomCommun(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
