...
public class XMLElementAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("common.types.xml.XMLElementAnnotation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "common.types.xml.XMLElementAnnotation");
  ...
  public String getQualifiedName(int addr) {
      ...
      jcas.throwFeatMissing("qualifiedName", "common.types.xml.XMLElementAnnotation");
  ...
  public String getLocalName(int addr) {
      ...
      jcas.throwFeatMissing("localName", "common.types.xml.XMLElementAnnotation");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("children", "common.types.xml.XMLElementAnnotation");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("parent", "common.types.xml.XMLElementAnnotation");
  ...
  public int getAttributes(int addr) {
      ...
      jcas.throwFeatMissing("attributes", "common.types.xml.XMLElementAnnotation");
  ...
  public XMLElementAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_parent = jcas.getRequiredFeatureDE(casType, "parent", "common.types.xml.XMLElementAnnotation", featOkTst);
