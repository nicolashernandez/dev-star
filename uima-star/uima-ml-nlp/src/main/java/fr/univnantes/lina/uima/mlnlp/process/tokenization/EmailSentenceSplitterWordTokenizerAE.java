...
/**
 * Annotator that segments the email both into sentences and words with a regex approach
 * 
 */
public class EmailSentenceSplitterWordTokenizerAE extends JCasAnnotator_ImplBase {
