...
public class NamedEntity_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getGender(int addr) {
      ...
      jcas.throwFeatMissing("gender", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getNumber(int addr) {
      ...
      jcas.throwFeatMissing("number", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getSubCategory(int addr) {
      ...
      jcas.throwFeatMissing("subCategory", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getRuleId(int addr) {
      ...
      jcas.throwFeatMissing("ruleId", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getAnnotatorId(int addr) {
      ...
      jcas.throwFeatMissing("annotatorId", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getStatus(int addr) {
      ...
      jcas.throwFeatMissing("status", "fr.univnantes.lina.uima.types.NamedEntity");
  ...
  public String getLanguage(int addr) {
      ...
      jcas.throwFeatMissing("language", "fr.univnantes.lina.uima.types.NamedEntity");
