...
public class Amount_Type extends NamedEntity_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.univnantes.lina.uima.types.Amount");
  ...
  public float getAmountDigit(int addr) {
      ...
      jcas.throwFeatMissing("amountDigit", "fr.univnantes.lina.uima.types.Amount");
  ...
  public String getAmountText(int addr) {
      ...
      jcas.throwFeatMissing("amountText", "fr.univnantes.lina.uima.types.Amount");
  ...
  public String getAmountUnit(int addr) {
      ...
      jcas.throwFeatMissing("amountUnit", "fr.univnantes.lina.uima.types.Amount");
