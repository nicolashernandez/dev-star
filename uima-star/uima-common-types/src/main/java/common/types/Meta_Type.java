 ...
 * @generated */
public class Meta_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Meta_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Meta_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Meta(addr, Meta_Type.this);
  			   Meta_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Meta(addr, Meta_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Meta.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("common.types.Meta");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "common.types.Meta");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "common.types.Meta");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Meta_Type(JCas jcas, Type casType) {
    super(jcas, casType);
